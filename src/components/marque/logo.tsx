...
export function LogoPorteo({ className }: { className?: string }) {
  return (
    <span className={cn('inline-flex flex-col leading-none', className)}>
      <span className="text-lg font-bold tracking-[0.18em] text-primary">PORTEO</span>
      <span className="text-[0.6rem] font-semibold tracking-[0.34em] text-accent">GROUP</span>
    </span>
  );
}
